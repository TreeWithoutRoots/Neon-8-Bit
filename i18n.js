...
(function () {
  ...
  var zh = {
    ...
    'hero.desc': '还原 FC 红白机四声道：<strong>P1/P2 方波</strong>（占空比+扫频）· <strong>TRI 三角波</strong>低音 · <strong>NSE 噪声</strong>鼓点<br />多段编排，奏响你的 8-bit 游戏旋律～',
    ...
    'param.triNote': '三角波无音量控制，仅开关。同一音高比方波低一个八度，适合低音线。滑音：从前一个音符平滑过渡到当前音符。',
    'param.mode': '模式',
    ...
    'help.intro.body': '<p>NEON 8-BIT 是一台运行在浏览器里的 <strong>NES 2A03 芯片合成器</strong>，忠实还原红白机（FC）的四声道：P1/P2 方波、TRI 三角波、NSE 噪声。</p><p>你只需在网格上「点格子」，就能写出 8-bit 芯片音乐，并编排成完整歌曲。</p>',
    ...
    'help.channels.title': '🎛 四声道',
    'help.channels.body': '<ul><li><strong>P1 方波</strong>：主旋律，支持占空比、扫频、滑音、颤音。</li><li><strong>P2 方波</strong>：和声 / 第二旋律，能力与 P1 相同。</li><li><strong>TRI 三角波</strong>：低音线，无音量控制，比方波低一个八度。</li><li><strong>NSE 噪声</strong>：鼓点与打击乐，可选长/短噪声与鼓类型。</li></ul>',
    ...
    'help.midi.body': '<ul><li><strong>导入</strong>：点「📂 导入 MIDI 文件」选择 .mid，自动映射到四声道。</li><li><strong>导出</strong>：点「⬇️ 导出 MIDI」把当前歌曲下载为 .mid，可在 DAW 中打开。</li></ul>',
  ...
  var en = {
    ...
    'hero.desc': 'Faithful NES four-channel: <strong>P1/P2 Square</strong> (duty + sweep) · <strong>TRI Triangle</strong> bass · <strong>NSE Noise</strong> drums<br />Arrange sections and play your 8-bit game melody!',
    ...
    'param.triNote': 'Triangle has no volume control, only on/off. One octave lower than square at the same pitch, great for bass lines. Glide: slides from previous to current note.',
    'param.mode': 'Mode',
    ...
    'help.intro.body': '<p>NEON 8-BIT is an in-browser <strong>NES 2A03 chip synthesizer</strong> that faithfully reproduces the Famicom four channels: P1/P2 Square, TRI Triangle, and NSE Noise.</p><p>Just tap cells on the grid to write 8-bit chiptune and arrange it into a full song.</p>',
    ...
    'help.channels.title': '🎛 Four Channels',
    'help.channels.body': '<ul><li><strong>P1 Square</strong>: lead melody with duty, sweep, glide, and vibrato.</li><li><strong>P2 Square</strong>: harmony / second melody, same as P1.</li><li><strong>TRI Triangle</strong>: bass line; no volume control, one octave lower than square.</li><li><strong>NSE Noise</strong>: drums and percussion with long/short mode and drum types.</li></ul>',
    ...
    'help.midi.body': '<ul><li><strong>Import</strong>: tap "📂 Import MIDI" and pick a .mid file; it auto-maps to the four channels.</li><li><strong>Export</strong>: tap "⬇️ Export MIDI" to download the current song as a .mid for use in a DAW.</li></ul>',
