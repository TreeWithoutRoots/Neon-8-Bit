...
(function () {
  ...
  var zh = {
    ...
    'hero.desc': '扩展 NES 七声道：<strong>P1/P2/P3/P4 方波</strong>（占空比+扫频）· <strong>TRI 三角波</strong>低音 · <strong>NSE 噪声</strong>鼓点 · <strong>SAW 锯齿波</strong>主旋律<br />多段编排，奏响你的 8-bit 游戏旋律～',
    ...
    'help.intro.body': '<p>NEON 8-BIT 是一台运行在浏览器里的 <strong>NES 2A03 芯片合成器</strong>，在经典四声道基础上扩展为七声道：P1/P2/P3/P4 方波、TRI 三角波、NSE 噪声、SAW 锯齿波。</p><p>你只需在网格上「点格子」，就能写出 8-bit 芯片音乐，并编排成完整歌曲。</p>',
    ...
    'help.channels.title': '🎛 七声道',
    'help.channels.body': '<ul><li><strong>P1 方波</strong>：主旋律，支持占空比、扫频、滑音、颤音。</li><li><strong>P2 方波</strong>：和声 / 第二旋律，能力与 P1 相同。</li><li><strong>TRI 三角波</strong>：低音线，无音量控制，音色柔和。</li><li><strong>NSE 噪声</strong>：鼓点与打击乐，可选长/短噪声与鼓类型。</li><li><strong>P3/P4 方波</strong>：扩展方波声道，能力与 P1/P2 相同，可承载更多复音。</li><li><strong>SAW 锯齿波</strong>：扩展声道，拥有丰富谐波，音色厚实，适合主旋律。</li></ul>',
    ...
    'help.midi.body': '<ul><li><strong>导入</strong>：点「📂 导入 MIDI 文件」选择 .mid，自动映射到七声道。</li><li><strong>导出</strong>：点「⬇️ 导出 MIDI」把当前歌曲下载为 .mid，可在 DAW 中打开。</li></ul>',
  ...
  var en = {
    ...
    'hero.desc': 'Expanded NES seven-channel: <strong>P1/P2/P3/P4 Square</strong> (duty + sweep) · <strong>TRI Triangle</strong> bass · <strong>NSE Noise</strong> drums · <strong>SAW Sawtooth</strong> lead<br />Arrange sections and play your 8-bit game melody!',
    ...
    'help.intro.body': '<p>NEON 8-BIT is an in-browser <strong>NES 2A03 chip synthesizer</strong> expanded from the classic four channels to seven: P1/P2/P3/P4 Square, TRI Triangle, NSE Noise, and SAW Sawtooth.</p><p>Just tap cells on the grid to write 8-bit chiptune and arrange it into a full song.</p>',
    ...
    'help.midi.body': '<ul><li><strong>Import</strong>: tap "📂 Import MIDI" and pick a .mid file; it auto-maps to the seven channels.</li><li><strong>Export</strong>: tap "⬇️ Export MIDI" to download the current song as a .mid for use in a DAW.</li></ul>',
